...
- Built-in fire-gate CONTENT cross-check: after render, verify the page's city + phone
  match the v8 record; any mismatch -> FAIL (never ship a page whose content is wrong).
...
QUARANTINE_DIR = f"{BASE_DIR}/.quarantine_v8_invalid"
...
def main():
    src = "/home/team/shared/new_email_candidates_v8.json"
    ...
    if not isinstance(data, list):
        print("Unrecognized v8 list format (expected list or {leads:[...]})")
        sys.exit(3)
    os.makedirs(QUARANTINE_DIR, exist_ok=True)
    print(f"v8 leads in list: {len(data)}")
    ...
    out = "/home/team/shared/v8_demo_build_report.json"
